    ...
    <div class="sidebar-inner slimscrollleft">
        ...
        <div id="sidebar-menu">
            <ul>
                ...
                <li class="has_sub" style="padding-top: 50px;">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="add-ProductsKeeper.php">Add Products</a></li>
                        <li><a href="manage-ProductsKeeper.php">Manage Products</a></li>
                    </ul>
                </li>
                <li class="has_sub">
                    <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-format-list-bulleted"></i>
                    ...
                    <ul class="list-unstyled">
                        <li><a href="manage-OrderListKeeper.php">Manage Order List</a></li>
                    </ul>
                </li>
