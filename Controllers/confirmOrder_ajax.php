     ...
     if(isset($_GET['user_id']) ){
          ...
          try{
               ...
               foreach ($cartTable as $cart) {
                    $sum+=$cart[4];
                    try{
                         $consql= "INSERT INTO admin_orders (cart_id, user_id, product_id, product_qty,individual_total, total_price, approved, orderFor) VALUES ('".$cart[0]."','".$cart[1]."','".$cart[2]."','".$cart[3]."','".$cart[4]."','".$sum."','0','".$cart[5]."')";
